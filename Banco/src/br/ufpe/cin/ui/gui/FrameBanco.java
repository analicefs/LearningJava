...
public class FrameBanco extends JFrame {
	...
	public FrameBanco() {
		...
		fachada = new Banco(new RepositorioContasArray(200));
	...
	private void erroNegativo(String mensagem) {
		JOptionPane.showMessageDialog(this, mensagem);
		tf_numero.selectAll();
	...
	private JRadioButton getRb_PoupancaEspecial() {
		if (rb_poupancaEspecial == null) {
			...
			rb_poupancaEspecial.setText("Conta especial");
			rb_poupancaEspecial.setBounds(new Rectangle(223, 5, 131, 23));
		}
